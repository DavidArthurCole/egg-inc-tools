      ...
      <div className="mx-auto max-w-screen-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 m-4">
          ...
          <div className="col-span-1 md:col-span-2 mt-6 text-black dark:text-white text-opacity-40 text-xs text-center">
            Created by <a href="https://github.com/SaladFork/" target="_blank">Fork</a>.
            Updated and maintained by <a href="https://github.com/DavidArthurCole" target="_blank">Daveed</a>.
            <br />
